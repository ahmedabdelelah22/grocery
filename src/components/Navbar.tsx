        ...
        <div className="w-full flex items-center gap-4 justify-end lg:gap-10">
          ...
          <form onSubmit={handleSearch} className="hidden sm:flex flex-1 max-w-sm text-xs sm:text-sm">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-8 p-2 bg-orange-50 rounded-full ring ring-app-orange/15 focus:ring-app-orange/30 focus:outline-none transition"
                value={searchQuery}
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-app-orange text-white text-[10px] w-5 h-5 rounded-full flex-center">
                  {cartCount}
                </span>
              )}
            </button>
            ...
            <div className="relative">
              {user ? (
                ...
                >
                  ...
                  <ChevronDownIcon className="size-3 text-zinc-900" />
                </button>
              ) : (
              ...
              {userMenuOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2.5 w-56 bg-white border border-app-border rounded-xl shadow-lg py-2 z-50 animated fadeIn">
                    {user && (
                    ...
                    {user && (
                       ...
                       <button className="flex item-center  text-left gap-3  px-4 py-2 text-sm text-app-error hover:bg-red-50 w-full transition-colors duration-200" onClick={handleLogout}>
