...
const NewsLetter = () => {
  return (
    <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-auto shadow-xl mt-32 mb-20">
 ...
 <MailIcon className="size-8 text-app-green " strokeWidth={1.5} />
    ...
    <form onSubmit={(e)=> e.preventDefault()} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
        <input type="text" className="flex-1 px-5 py-3.5 rounded-xl border border-app-border focus:border-app-green focus:ring bg-white text-sm transition-all" placeholder="Enter your email address" required/>
