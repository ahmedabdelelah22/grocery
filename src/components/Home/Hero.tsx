    ...
    <section className="relative overflow-hidden min-h-135 mb-10 rounded-3xl flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            ...
            <div className="flex flex-wrap gap-3">
                <Link to='/products' className="px-7 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-orange-500 transition-all flex-center gap-2 active:scale-[0.98]">shop Now <ArrowRightIcon /> </Link>
                <Link to='/products' className="px-7 py-3 bg-white/10  text-white font-semibold rounded-full hover:bg-withe/20  transition-all border border-white/20">Browse Categories</Link>
