          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full
                            px-4 py-2.5 text-sm rounded-xl border border-app-border focus:border-app-green outline-none
                            "
                value={form.label}
                onClick={(e) => setForm({ ...form, label: e.currentTarget.value })}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-app-green mb-1.5">
              ...
              <input
                ...
                className="w-full
                            ...
                            "
                value={form.address}
                onClick={(e) => setForm({ ...form, address: e.currentTarget.value })}
              />
            </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full
                            ...
                            "
                  value={form.city}
                  onClick={(e) => setForm({ ...form, city: e.currentTarget.value })}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-app-green mb-1.5">
                ...
                <input
                  ...
                  className="w-full
                            ...
                            "
                  value={form.state}
                  onClick={(e) => setForm({ ...form, state: e.currentTarget.value })}
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="w-full
                            ...
                            "
                  value={form.zip}
                  onClick={(e) => setForm({ ...form, zip: e.currentTarget.value })}
                />
                </div>
